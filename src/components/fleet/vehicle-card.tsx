...
import { Cog, Users, Fuel, ArrowUpRight } from "lucide-react";
      ...
      >
        ...
        <div className="relative z-20 flex flex-1 flex-col p-6" style={{ transform: "translateZ(40px)" }}>
          ...
          <div className="mt-5 grid grid-cols-3 gap-2 border-t border-white/[0.07] pt-5 text-center">
            ...
            <Spec icon={<Cog className="h-4 w-4" />} value="Auto" label="Gearbox" />
            <Spec icon={<Fuel className="h-4 w-4" />} value={vehicle.fuel} label="Fuel" />
          </div>
